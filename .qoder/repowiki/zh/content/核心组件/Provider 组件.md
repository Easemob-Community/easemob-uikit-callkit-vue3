...
- 新增用户信息提供者缓存机制，通过 GlobalCallStore 提升查询性能
...
**图表来源**
- [lib/components/EasemobChatCallKitProvider.vue:127-153](file://lib/components/EasemobChatCallKitProvider.vue#L127-L153)
...
**章节来源**
- [lib/components/EasemobChatCallKitProvider.vue:65-153](file://lib/components/EasemobChatCallKitProvider.vue#L65-L153)
...
**章节来源**
- [lib/components/EasemobChatCallKitProvider.vue:114-142](file://lib/components/EasemobChatCallKitProvider.vue#L114-L142)
...
- [lib/types.ts:1-103](file://lib/types.ts#L1-L103)
- [lib/composables/useListenerManager.ts:1-262](file://lib/composables/useListenerManager.ts#L1-L262)
- [lib/services/RtcService.ts:1-771](file://lib/services/RtcService.ts#L1-L771)
- [lib/services/UserProfileService.ts:1-137](file://lib/services/UserProfileService.ts#L1-L137)
...
- 未挂载事件监听器
  ...
  - 参考：[lib/components/EasemobChatCallKitProvider.vue:109-112](file://lib/components/EasemobChatCallKitProvider.vue#L109-L112)

- RTC 初始化失败
  - 现象：日志报错"RTC服务初始化失败"
  - 排查：确认环信客户端已登录并可获取 userId 映射；检查占位 appId 的使用是否符合预期
  - 参考：[lib/store/rtcChannel.ts:97-100](file://lib/store/rtcChannel.ts#L97-L100)
...
- **新增** 用户信息提供者未生效
  ...
  - 参考：[lib/components/EasemobChatCallKitProvider.vue:128-142](file://lib/components/EasemobChatCallKitProvider.vue#L128-L142)
...
- **新增** 默认用户信息提供者创建失败
  ...
  - 参考：[lib/components/EasemobChatCallKitProvider.vue:132-137](file://lib/components/EasemobChatCallKitProvider.vue#L132-L137)
...
- Provider 内存泄漏
  ...
  - 参考：[lib/components/EasemobChatCallKitProvider.vue:149-153](file://lib/components/EasemobChatCallKitProvider.vue#L149-L153)

- 邀请超时行为异常
  - 现象：多人通话超时后界面未自动隐藏
  - 说明：多人通话场景下超时后保持界面等待用户手动挂断，属设计行为
  - 参考：[lib/store/callState.ts:99-101](file://lib/store/callState.ts#L99-L101)
...
- 组件卸载后仍有媒体占用
  ...
  - 参考：[lib/services/RtcService.ts:730-771](file://lib/services/RtcService.ts#L730-L771)

**更新** 新增用户信息提供者相关的故障排查指南

**章节来源**
- [lib/components/EasemobChatCallKitProvider.vue:109-112](file://lib/components/EasemobChatCallKitProvider.vue#L109-L112)
- [lib/store/rtcChannel.ts:97-100](file://lib/store/rtcChannel.ts#L97-L100)
- [lib/store/globalCall.ts:14-54](file://lib/store/globalCall.ts#L14-L54)
- [lib/store/callState.ts:99-101](file://lib/store/callState.ts#L99-L101)
- [lib/utils/logger.ts:91-94](file://lib/utils/logger.ts#L91-L94)
- [lib/services/RtcService.ts:730-771](file://lib/services/RtcService.ts#L730-L771)
