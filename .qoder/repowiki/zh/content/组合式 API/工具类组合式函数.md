...
## 更新摘要
**变更内容**
- 新增 useDraggable 组合式函数的详细文档，包含居中定位选项、改进的 TypeScript 类型定义
- 更新拖拽功能的初始化逻辑和视觉反馈增强说明
- 补充 useCenteredDraggable 和 useCornerDraggable 辅助函数的使用说明
- 完善拖拽组件的使用示例和最佳实践
...
**图表来源**
- [useCallKit.ts](file://lib/composables/useCallKit.ts#L1-L123)
- [useCallService.ts](file://lib/composables/useCallService.ts#L1-L299)
- [useRtcService.ts](file://lib/composables/useRtcService.ts#L1-L192)
- [useSignalManager.ts](file://lib/composables/useSignalManager.ts#L1-L354)
- [useListenerManager.ts](file://lib/composables/useListenerManager.ts#L1-L730)
- [useDraggable.ts](file://lib/composables/useDraggable.ts#L1-L323)
...
**图表来源**
- [useCallKit.ts](file://lib/composables/useCallKit.ts#L13-L50)
- [useSignalManager.ts](file://lib/composables/useSignalManager.ts#L73-L102)
- [useListenerManager.ts](file://lib/composables/useListenerManager.ts#L619-L677)
- [useRtcService.ts](file://lib/composables/useRtcService.ts#L52-L192)
- [useCallService.ts](file://lib/composables/useCallService.ts#L91-L299)
- [useDraggable.ts](file://lib/composables/useDraggable.ts#L78-L263)
...
**更新** 新增详细的拖拽组合式函数文档，包含居中定位选项、改进的 TypeScript 类型定义、更好的初始化逻辑和视觉反馈增强
...
**图表来源**
- [useDraggable.ts](file://lib/composables/useDraggable.ts#L131-L263)
...
- 计时异常
  ...
  - 参考
    - [useCallTimer.ts](file://callkit/hooks/useCallTimer.ts#L10-L42)
- 拖拽异常
  - 症状：拖拽失效、元素跳出边界、触摸事件冲突
  - 排查：确认元素具有正确的定位属性；检查边界参数设置；验证事件监听器是否正确清理
  - 参考
    - [useDraggable.ts](file://lib/composables/useDraggable.ts#L174-L227)
- 信令未达/状态不一致
  - 症状：被叫未弹窗、状态卡住
...
- 音视频异常
  ...
  - 参考
    - [useRtcService.ts](file://lib/composables/useRtcService.ts#L66-L123)
- 通话状态未更新
  - 症状：UI 不随状态变化
  - 排查：确认 useCallService 返回的状态与事件监听是否正确绑定
  - 参考
    - [useCallService.ts](file://lib/composables/useCallService.ts#L96-L158)
...
- useDraggable 为拖拽交互提供了完整、易用的解决方案，支持多种定位模式和边界限制
