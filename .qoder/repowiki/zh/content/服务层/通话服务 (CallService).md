...
**更新** 本次更新增强了 `buildInviteMessageExt` 方法，支持异步调用和自动注入调用者信息，提升了通话邀请消息的完整性和可靠性。
...
**图表来源**
- [CallService.ts:116-285](file://callkit/services/CallService.ts#L116-L285)
- [CallError.ts:1-43](file://callkit/services/CallError.ts#L1-L43)
- [ringtoneManager.ts:1-138](file://callkit/utils/ringtoneManager.ts#L1-L138)
- [callUtils.ts:1-85](file://callkit/utils/callUtils.ts#L1-L85)
...
- [useCallService.ts:82-123](file://lib/composables/useCallService.ts#L82-L123)
...
- [useListenerManager.ts:1-683](file://lib/composables/useListenerManager.ts#L1-L683)
- [useCallService.ts:82-123](file://lib/composables/useCallService.ts#L82-L123)
- [useEndCall.ts:100-130](file://lib/composables/useEndCall.ts#L100-L130)

## 架构总览
CallService 通过环信 IM 发送信令消息，通过 Agora RTC 完成音视频传输。服务层与 Store 层解耦，通过回调与事件驱动的方式进行状态同步。新增的 UserProfileService 提供异步用户信息查询，支持自动注入调用者信息到邀请消息中。
...
**图表来源**
- [CallService.ts:345-527](file://callkit/services/CallService.ts#L345-L527)
- [CallService.ts:686-727](file://callkit/services/CallService.ts#L686-L727)
- [CallService.ts:806-1358](file://callkit/services/CallService.ts#L806-L1358)
- [CallService.ts:1360-1775](file://callkit/services/CallService.ts#L1360-L1775)
...
**图表来源**
- [CallService.ts:116-285](file://callkit/services/CallService.ts#L116-L285)
- [CallService.ts:291-308](file://callkit/services/CallService.ts#L291-L308)
- [CallService.ts:345-527](file://callkit/services/CallService.ts#L345-L527)
- [CallService.ts:686-727](file://callkit/services/CallService.ts#L686-L727)
- [CallService.ts:806-1358](file://callkit/services/CallService.ts#L806-L1358)
- [CallService.ts:1360-1775](file://callkit/services/CallService.ts#L1360-L1775)
- [CallService.ts:1777-1791](file://callkit/services/CallService.ts#L1777-L1791)
- [CallService.ts:1793-2182](file://callkit/services/CallService.ts#L1793-L2182)
- [CallService.ts:2225-2254](file://callkit/services/CallService.ts#L2225-L2254)
- [CallService.ts:2400-3199](file://callkit/services/CallService.ts#L2400-L3199)
- [CallService.ts:4376-4477](file://callkit/services/CallService.ts#L4376-L4477)
...
**图表来源**
- [CallService.ts:345-527](file://callkit/services/CallService.ts#L345-L527)
- [CallService.ts:529-684](file://callkit/services/CallService.ts#L529-L684)
- [CallService.ts:686-727](file://callkit/services/CallService.ts#L686-L727)
- [CallService.ts:729-762](file://callkit/services/CallService.ts#L729-L762)
- [UserProfileService.ts:48-61](file://lib/services/UserProfileService.ts#L48-L61)
- [CallService.ts:2335-2366](file://callkit/services/CallService.ts#L2335-L2366)
- [CallService.ts:2368-2446](file://callkit/services/CallService.ts#L2368-L2446)
...
**图表来源**
- [CallService.ts:1360-1683](file://callkit/services/CallService.ts#L1360-L1683)
- [CallService.ts:1685-1775](file://callkit/services/CallService.ts#L1685-L1775)
...
**章节来源**
- [CallError.ts:1-43](file://callkit/services/CallError.ts#L1-L43)
- [CallService.ts:2359-2365](file://callkit/services/CallService.ts#L2359-L2365)
- [CallService.ts:854-873](file://callkit/services/CallService.ts#L854-L873)
- [CallService.ts:974-983](file://callkit/services/CallService.ts#L974-L983)
- [CallService.ts:1157-1164](file://callkit/services/CallService.ts#L1157-L1164)
...
- [ringtoneManager.ts:1-138](file://callkit/utils/ringtoneManager.ts#L1-L138)
- [CallService.ts:4376-4477](file://callkit/services/CallService.ts#L4376-L4477)
- [CallService.ts:2679-2732](file://callkit/services/CallService.ts#L2679-L2732)
- [CallService.ts:3129-3188](file://callkit/services/CallService.ts#L3129-L3188)
- [CallService.ts:2150-2181](file://callkit/services/CallService.ts#L2150-L2181)
...
**图表来源**
- [CallService.ts:570-595](file://callkit/services/CallService.ts#L570-L595)
- [UserProfileService.ts:48-61](file://lib/services/UserProfileService.ts#L48-L61)
...
**图表来源**
- [CallService.ts:1-12](file://callkit/services/CallService.ts#L1-L12)
- [UserProfileService.ts:1-88](file://lib/services/UserProfileService.ts#L1-L88)
- [useListenerManager.ts:1-683](file://lib/composables/useListenerManager.ts#L1-L683)
- [useCallService.ts:82-123](file://lib/composables/useCallService.ts#L82-L123)
- [useEndCall.ts:100-130](file://lib/composables/useEndCall.ts#L100-L130)
...
## 结论
CallService 通过清晰的生命周期管理、严谨的资源清理与完善的错误处理，实现了与环信与 Agora 的深度集成。配合 Store 层的状态抽象与组合式 API 的易用封装，能够满足从单人到群组的多种通话场景。**新增的异步用户信息注入功能**进一步提升了通话体验，使邀请消息更加完整和友好。建议在生产环境中重点关注多端冲突、资源释放与 Android 设备适配，以及用户信息提供者的正确配置，以获得更稳定的用户体验。
...
- [CallService.ts:1360-1775](file://callkit/services/CallService.ts#L1360-L1775)
- [CallService.ts:2679-2732](file://callkit/services/CallService.ts#L2679-L2732)
- [CallService.ts:2734-3127](file://callkit/services/CallService.ts#L2734-L3127)
...
**章节来源**
- [CallService.ts:14-66](file://callkit/services/CallService.ts#L14-L66)
- [callState.ts:1-263](file://lib/store/callState.ts#L1-L263)
- [rtcChannel.ts:1-50](file://lib/store/rtcChannel.ts#L1-L50)
